  ...
  init: function init() {
    ...
    if ($nextEl && $nextEl.length > 0) {
      $nextEl.on('click', function (e) {
        ...
        // alert("哈哈哈")
          if(!swiper3.isEnd)
          {
              $(".swiper-wrapper").css({"transform":"translate3d(-640px, 0px, 0px)","transition":"0.3s"})
          }
    ...
    if ($prevEl && $prevEl.length > 0) {
      ...
      $prevEl.on('click', function (e) {
          // alert("向前",swiper.isBeginning,swiper.params.loop)
          console.log("向前",swiper.isBeginning,swiper.params.loop)
        e.preventDefault();
        if (swiper.isBeginning && !swiper.params.loop) { return; }
         $(".swiper-wrapper").css({"transform":"","transition":"0.3s"})
        swiper.slidePrev();
        console.log("向前滑动")
      });
    }
